...
<div id="footer">
	<div style="line-height: 2em;" class="center middle">
        ...
        <g:if test="${gitProperties}">
            ...
            <g:message code="application.buildNumber.label"/>: <b><a href="https://github.com/openboxes/openboxes/commit/${gitProperties?.commitId}">${gitProperties?.shortCommitId ?: "N/A"}</a></b>&nbsp;&nbsp; | &nbsp;&nbsp;
        </g:if>
