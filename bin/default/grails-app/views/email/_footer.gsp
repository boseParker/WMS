...
<div style="line-height: 2em; font-size: 9px; color: #999; text-align: center; border-top: 1px solid lightgrey;">
	...
	<warehouse:message code="application.buildNumber.label"/>: <b><a href="https://github.com/openboxes/openboxes/commit/${gitProperties?.commitId}">${gitProperties?.shortCommitId ?: "N/A"}</a></b>&nbsp;&nbsp; | &nbsp;&nbsp;
